...
namespace YiDaBus.Com.Manager.Common
{
    public class Utils
    {
        ...
        public static void DeleteCookies(string name)
        {
            HttpCookie curCookie = HttpContext.Current.Request.Cookies[name];
            if (curCookie != null)
            {
        ...
        public static string HttpGet(string url, string param)
        {
            ...
            request.Method = "GET";
            // 添加header
            request.Headers.Add("apikey", "014ff8d54e799ceb49189ef51da7670e");
            //request.Headers.Add("Host", "m.anjuke.com");
            //request.Headers.Add("Referer", "http://m.anjuke.com/sh/community/");
            ...
            //request.Headers.Add("Cookie", "sessid=C08F8C08-7210-6955-AF2D-CE69E04ED6A9; lps=http%3A%2F%2Fwww.anjuke.com%2Fshanghai%2Fcm%2F%7Chttps%3A%2F%2Fwww.baidu.com%2Flink%3Furl%3D3-_uAW3zOgBUJbLiscN3Nsj1n98nN9W12Rcl_PgyYXSJ2_Rs10V37m33DLhiVfpH%26wd%3D%26eqid%3Dabfa989c000237730000000458ae7c46; als=0; ajk_member_captcha=38c94c6620e717c52ff40b8528835068; _ga=GA1.2.1475952913.1487830168; isp=true; twe=2; Hm_lvt_c5899c8768ebee272710c9c5f365a6d8=1487830103; Hm_lpvt_c5899c8768ebee272710c9c5f365a6d8=1487831413; search_words11=xiaoqu; Ref=http%3A%2F%2Fm.anjuke.com%2Fsh%2Fcm; speed=0; Hm_lvt_d3e6ebed001da95304bcf4271eba64de=1487831352; Hm_lpvt_d3e6ebed001da95304bcf4271eba64de=1487831466; 58tj_uuid=4592f7f0-f846-4770-9b70-c7efdb407220; new_session=0; init_refer=; new_uv=1; aQQ_ajkguid=83B496A4-B865-EB0F-1D5F-99829ACDB78C; ctid=11");
