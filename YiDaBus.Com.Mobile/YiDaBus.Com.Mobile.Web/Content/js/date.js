...
(function ($) {
    $.fn.date = function (options, Ycallback, Ncallback) {
        ...
        var initY = 2;//parseInt((nowdate.getFullYear()))-1;
        var initM = 2;//parseInt(nowdate.getMonth()+"")+1;
        var initD = 2;//parseInt(nowdate.getDate()+"");
        ...
        function refreshDate() {
            ...
            resetInitDete();
            yearScroll.scrollTo(0, initY * 40 - 40, 100, true);
        ...
        function bindButton() {
            ...
            $("#dateconfirm").unbind('click').click(function () {
                ...
                $("#HRoom").val($("#yearwrapper ul li:eq(" + indexY + ")").data("value"));
                $("#HOffice").val($("#monthwrapper ul li:eq(" + indexM + ")").data("value"));
                $("#HWashroom").val($("#daywrapper ul li:eq(" + Math.round(indexD) + ")").data("value"));
        ...
        function CreateDateUI() {
            var str = '' +
                ...
                '<div id="datePage" class="page">' +
                    '<section>' +
                        '<div id="datetitle"><h1>请选择户型</h1></div>' +
        ...
        function createYEAR_UL() {
            ...
            for (var i = 0; i < room.length; i++) {
                str += '<li data-value="' + (i + 1) + '">' + room[i] + '室</li>'
            }
            return str + "<li>&nbsp;</li>";;
        }
        //创建 --月-- 列表
        function createMONTH_UL() {
            ...
            for (var i = 0; i < office.length; i++) {
                ...
                str += '<li data-value="' + i + '">' + office[i] + '厅</li>'
            }
            return str + "<li>&nbsp;</li>";;
        }
        //创建 --日-- 列表
        function createDAY_UL() {
            ...
            $("#daywrapper ul").html("");
            var str = "<li>&nbsp;</li>";
            for (var i = 0; i < washrom.length; i++) {
                str += '<li data-value="' + i + '">' + washrom[i] + '卫</li>'
            }
            return str + "<li>&nbsp;</li>";;
        }
